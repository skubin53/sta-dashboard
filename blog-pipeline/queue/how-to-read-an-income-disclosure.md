...
day: 14
date: 2026-08-31
title: How Do You Read an Income Disclosure Statement? (2026)
slug: how-to-read-an-income-disclosure
keyword: how to read income disclosure statement
category: Builders
cover: https://scan.ismyhometoxic.com/blog-images/howtoreadan-hero-v1.webp
meta_description: Federal Trade Commission staff read 70 income disclosure statements. None of them counted expenses. Here is how to find yourself in the next one.
...
table{width:100%;border-collapse:collapse;margin:22px 0;font-size:.95em;}
th{background:#FBF7F0;color:#0B2545;text-align:left;padding:10px 12px;border-bottom:2px solid #e3e0d8;font-size:.85em;text-transform:uppercase;letter-spacing:.04em;}
td{padding:10px 12px;border-bottom:1px solid #e3e0d8;vertical-align:top;}
...
.sta-proof ul{margin:0;padding-left:20px;}
.sta-proof li{margin:7px 0;line-height:1.55;}
...
.sta-keep li{margin:6px 0;}
.sta-author{background:#FBF7F0;border-radius:10px;padding:20px 24px;margin:28px 0 0;}
.sta-author h3{margin:0 0 8px;color:#0B2545;font-size:1em;}
.sta-author p{margin:0;line-height:1.6;color:#1B2A41;}
figure{margin:28px 0;}
figure img{width:100%;border-radius:10px;}
</style>

<div class="sta-byline">
By <a href="https://join.switchtoamerica.com/post/about-shannon-nicole">Shannon Nicole</a> &middot; Published August 31, 2026 &middot; Last updated August 31, 2026
</div>
...
<ol>
<li><a href="#what-is-it">What the page actually is</a></li>
<li><a href="#find-yourself">Why you are not on it</a></li>
<li><a href="#active">What the word active is doing</a></li>
...
<h2 id="what-is-it">What is an income disclosure statement?</h2>

<p class="quick-answer">Quick answer: one page of numbers a company puts out about its own people. Reading it is a skill. Nobody teaches it.</p>
...
<p>Bring the statement you were sent. We will read it together, line by line, and I will show you where to look first.</p>
...
<h2 id="find-yourself">Why can you never find yourself in it?</h2>

<p class="quick-answer">Quick answer: because most of these pages leave people like you out.</p>

<p>This is the part that changed how I read them.</p>

<p>Of the seventy the agency read, <a href="https://www.ftc.gov/system/files/ftc_gov/pdf/mlm-ids-report.pdf">twenty-nine</a> "exclude from their income distribution all participants who did not earn commissions or similar income."</p>

<p>Read that again slowly. The people who made nothing were taken out before the page was printed.</p>

<p>Another twenty-four leave out anyone the company calls not active. Only eleven of the seventy showed everybody.</p>

<p>And so the page is not a picture of what happens. It is a picture of who it worked for.</p>

<h2 id="active">What does the word active actually mean?</h2>

<p class="quick-answer">Quick answer: whatever the company decides. It is usually written to leave people out.</p>
...
<p>Ask what the word means before you read a single number.</p>

<h2 id="average">Is the average telling you anything?</h2>

<p class="quick-answer">Quick answer: usually not. An average hides one big earner behind a hundred people who got nothing.</p>

<p>The agency put it in one line. Take a hundred people. Ninety-nine make nothing. One makes ten thousand dollars.</p>

<p>The average is one hundred dollars each.</p>

<p>Nobody in that room made a hundred dollars.</p>
...
<p class="quick-answer">Quick answer: your costs. Not one of the seventy counted them.</p>

<p>The report says it plainly. "None of the 70 income disclosure statements reviewed provides income figures that take into account all expenses."</p>
...
<tr><th>What the page shows</th><th>What it is not telling you</th></tr>
<tr><td>An average</td><td>Whether one person at the top is carrying it</td></tr>
<tr><td>Earnings of active people</td><td>Who got left out of the word active</td></tr>
<tr><td>A rank with a dollar figure</td><td>How many people never reached that rank</td></tr>
<tr><td>Money received</td><td>What it cost to receive it</td></tr>
</table>
...
<p>Who is missing from this page. Ask that first. If the people who made nothing were left out, the page cannot answer you.</p>

<p>What does active mean here. Get it in writing.</p>

<p>Is this a middle number or an average. If it is an average, ask for the middle one.</p>

<p>Does this count what I spend. It will not. Ask anyway, and watch what happens.</p>

<p>Four questions. Ten minutes. You can do it at the kitchen table with the tea going cold.</p>
...
<p>And anyone who is glad you asked is worth talking to.</p>
...
<p><strong>Is every one of these pages dishonest?</strong></p>
<p>No. Some are careful and some are clear. The point is that you cannot tell by glancing. Four questions and you will know which one you are holding.</p>

<p><strong>What if there is no statement at all?</strong></p>
<p>Then you have your answer sooner. Ask for one in writing. What comes back, and how fast, tells you a great deal.</p>

<p><strong>Is a middle number really that different from an average?</strong></p>
...
<p>You do not turn into someone who trusts nothing. That is tiring, and it is not you.</p>

<p>You turn into someone who reads the page before she signs. Ten minutes, four questions, and the pile on the table stops being scary.</p>
...
<script type="application/ld+json">
{
 ...
 "@graph": [
  {"@type": "Article",
   "headline": "How Do You Read an Income Disclosure Statement? (2026)",
   "description": "Federal Trade Commission staff read 70 income disclosure statements. None of them counted expenses. Here is how to find yourself in the next one.",
   "datePublished": "2026-08-31",
   "dateModified": "2026-08-31",
   "image": "https://scan.ismyhometoxic.com/blog-images/howtoreadan-hero-v1.webp",
   "author": {"@id": "https://switchtoamerica.com/#shannon"},
   "publisher": {"@id": "https://switchtoamerica.com/#org"},
   "mainEntityOfPage": "https://theshannonnicole.com/post/how-to-read-an-income-disclosure"},
