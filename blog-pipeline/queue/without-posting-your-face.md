...
<ul>
<li><a href="#on-camera">Do you have to be on camera</a></li>
<li><a href="#before-somebody-buys">What has to happen before somebody buys</a></li>
<li><a href="#who-is-watching">Who is actually watching video at your age</a></li>
<li><a href="#slower">Isn't a quiet business just a slower one</a></li>
<li><a href="#monday">What I would do first on Monday</a></li>
<li><a href="#faq">Questions women are asking me about this</a></li>
</ul>
</div>

<h2 id="on-camera">Do you actually have to be on camera?</h2>

<p class="quick-answer">Quick answer: no. You do have to be findable. That is a different job.</p>

<p>You have run something for years. You have hired people and let people go. You have sat at a table and closed something that mattered. You have talked a frightened customer down on the phone at nine at night.</p>
...
<p class="quick-answer">Quick answer: four things. One of them suits a camera. Three of them suit you.</p>
...
<p class="quick-answer">Quick answer: often yes. Slower is not the same as smaller.</p>

<p>Here is the part I know you are thinking, because I thought it. Everybody winning at this seems to live on video. That is not nothing and I will not pretend it is.</p>
...
<p class="quick-answer">Quick answer: write twelve names down, then send one message.</p>

<h3>Write down twelve names</h3>
...
<p>You are not the brochure. Send her to something that explains it properly, and stay the person who answers her afterwards.</p>

<p>That split is the whole thing. The page explains. You are the reason she believes it.</p>
...
<li><a href="https://theshannonnicole.com/post/extra-income-for-women-in-their-50s">The real extra income options for women in their 50s</a>. All of them, honestly compared.</li>
...
<script type="application/ld+json">
{
 ...
 "@graph": [
  ...
  {
   "@type": "Person",
   "@id": "https://theshannonnicole.com/post/without-posting-your-face#author",
   "name": "Shannon Nicole",
   "jobTitle": "Founder",
  ...
  },
  {
   ...
   "itemListElement": [
    ...
    {"@type": "ListItem", "position": 3, "name": "Can You Build Something Without Posting Your Face?", "item": "https://theshannonnicole.com/post/without-posting-your-face"}
   ]
  }
 ]
}
