# Switch to America - Pinterest Pin Copy + Image Bank

**Image style (Shannon-approved 2026-09-21):** every pin is a REAL Shannon blog photo (from `blog-images/`) composited into a dark-navy 1000x1500 pin - photo showing in full color through the middle, gold + white text top and bottom. Dark theme, life and color, no flat text blocks. NO competitor product labels in frame. Regenerate with `distribution-bank/pin-compositor.py` (needs Pillow) using the recipe in each entry. Output files: `pinx_<slug>.png`.

**Wording (Shannon-approved):** headlines are scroll-stopping QUESTIONS tied to the real concern in that post (like her blog titles). Never a claim, always a question. "American Made", no percentages, no em dashes. Never name Melaleuca. Every description ends with the free scan line.

---

## Dawn dish soap  [pinx_dawn.png | photo: dawn-clean-kitchen-morning-v1.webp]
- **Headline / Title:** Is your dish soap causing cancer?
- **Eyebrow:** NON-TOXIC CLEANING  |  **Board:** Non-Toxic Cleaning Products
- **Link:** https://join.switchtoamerica.com/post/is-dawn-dish-soap-safe
- **Description:** The concern is 1,4-dioxane, a byproduct the EPA calls a likely human carcinogen that is not required on the label. Here is what I found when I checked a popular dish soap, and the gentler swap for hands that are in the sink all day. Free 3-minute room-by-room home scan: https://scan.ismyhometoxic.com/now/

## Fabuloso floor cleaner  [pinx_fabuloso.png | photo: fabuloso-freedom-v2.webp]
- **Headline / Title:** Is your floor cleaner growing bacteria?
- **Eyebrow:** NON-TOXIC CLEANING  |  **Board:** Non-Toxic Cleaning Products
- **Link:** https://join.switchtoamerica.com/post/is-fabuloso-safe
- **Description:** A recall pulled millions of bottles of a popular floor cleaner because bacteria could grow inside the sealed bottle. Here is what I found, and the safer swap for a clean, non-toxic home. Free 3-minute room-by-room home scan: https://scan.ismyhometoxic.com/now/

## Dryer sheets  [pinx_dryer.png | photo: aredryershe-freedom-v1.webp]
- **Headline / Title:** What are dryer sheets doing to your skin?
- **Eyebrow:** NON-TOXIC LAUNDRY  |  **Board:** Non-Toxic Laundry
- **Link:** https://join.switchtoamerica.com/post/are-dryer-sheets-toxic
- **Description:** Dryer sheets leave a fragranced coating on your clothes, your towels, and everything against your skin all day. Here is what I found, plus the fragrance-free swaps that still leave everything soft. Free 3-minute room-by-room home scan: https://scan.ismyhometoxic.com/now/

## Nonstick pans  [pinx_nonstick.png | photo: arenonstick-freedom-v1.webp]
- **Headline / Title:** Is your nonstick pan toxic?
- **Eyebrow:** SAFER COOKWARE  |  **Board:** Non-Toxic Cookware & Kitchen Swaps
- **Link:** https://join.switchtoamerica.com/post/are-nonstick-pans-toxic
- **Description:** What a nonstick coating can release into your food when it overheats, and the cookware swaps that last for decades with no coating to worry about. Free 3-minute room-by-room home scan: https://scan.ismyhometoxic.com/now/
...
- **Description:** What plug-ins and sprays actually release into the air you breathe all day, room by room, and the fragrance-free ways to freshen your home. Free 3-minute room-by-room home scan: https://scan.ismyhometoxic.com/now/
...
- **Description:** What a disinfectant spray does to the air in a closed bathroom, and the safer way to handle germs without the fume cloud. Free 3-minute room-by-room home scan: https://scan.ismyhometoxic.com/now/
...
- **Description:** Why that strong clean smell can tighten your chest, and the safer way to get a floor genuinely clean without the fumes. Free 3-minute room-by-room home scan: https://scan.ismyhometoxic.com/now/
...
- **Description:** What a fresh-linen spray actually adds to the air you breathe at home, and the fragrance-free way to freshen a room without the mystery scent. Free 3-minute room-by-room home scan: https://scan.ismyhometoxic.com/now/

## Tide detergent  [pinx_tide.png | photo: tide-freedom-v1.webp]
- **Headline / Title:** Is your laundry soap harming your skin?
- **Eyebrow:** NON-TOXIC LAUNDRY  |  **Board:** Non-Toxic Laundry
- **Link:** https://join.switchtoamerica.com/post/is-tide-laundry-detergent-toxic
- **Description:** What I checked in a popular laundry detergent before the next load, and the gentler swap for skin that reacts. Free 3-minute room-by-room home scan: https://scan.ismyhometoxic.com/now/

## Sunscreen  [pinx_sunscreen.png | photo: issunscreen-freedom-v1.webp]
- **Headline / Title:** Is your sunscreen in your blood?
- **Eyebrow:** CLEAN BEAUTY  |  **Board:** Clean Beauty & Safe Personal Care
- **Link:** https://join.switchtoamerica.com/post/is-sunscreen-safe
- **Description:** FDA testing found some sunscreen chemicals absorb into the bloodstream. Here is what I found, and the safer sun protection swap for the whole family. Free 3-minute room-by-room home scan: https://scan.ismyhometoxic.com/now/
...
## PUBLISHED 2026-09-25 (noon run) - 1 pin live, 2nd DEFERRED (builder would not hydrate)
Calendar Day 6/7 rotation. Published the next not-live pin (aluminum pans). The 2nd (cutting boards) is composed and ready (pinx_cuttingboard.png) but the pin-builder would not hydrate the uploader for a 2nd pin this run: loading shell only on both the reused tab AND a fresh tab, extension still connected, profile itself healthy (not a full throttle, the post-publish sluggishness also seen 9/24 noon). Stopped cleanly at 1 pin per the stuck/disconnect rule rather than hammer. 13 STA pins live now (was 12).

### Aluminum pans  [pinx_aluminum.png | photo: arecheapalu-freedom-v1.webp]  -> LIVE
- Title: Is there lead in your cheap pans? Safer non-toxic cookware
- Board: Non-Toxic Cookware & Kitchen Swaps
- Link: https://join.switchtoamerica.com/post/are-cheap-aluminum-pans-safe
- Confirmed by builder "You created a Pin!" dialog + form reset. Created-feed re-verify was blocked by session sluggishness; double-check it appears on the Created feed next run.

### Cutting boards  [pinx_cuttingboard.png | photo: areplasticc-freedom-v1.webp]  -> DEFERRED to next run
- Title (ready): What comes off your cutting board?
- Board: Non-Toxic Cookware & Kitchen Swaps
- Link: https://join.switchtoamerica.com/post/are-plastic-cutting-boards-safe

## GROWTH TASK 2026-09-25 (noon) (b) SEO-rewrite - stripped leftover hashtags from the whole pin copy-bank
